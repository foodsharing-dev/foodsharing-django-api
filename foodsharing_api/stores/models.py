...
class Store(models.Model):
    status = EnumIntegerField(Status, db_column='betrieb_status_id', default=Status.NO_CONTACT)
    ...
    cooperation_started_at = models.DateField(blank=True, null=True, db_column='begin')
    notes = models.TextField(blank=True, null=True, db_column='besonderheiten')
    notes_public = models.CharField(max_length=200, blank=True, null=True, db_column='public_info')
    estimated_fetch_time = EnumIntegerField(EstimatedFetchTime, db_column='public_time', default=EstimatedFetchTime.NONE)
    conviction = EnumIntegerField(Conviction, db_column='ueberzeugungsarbeit', default=Conviction.NONE)
